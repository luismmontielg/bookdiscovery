...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('books', ['UserProfile'])

        # Adding model 'BookRelation'
        db.create_table('books_bookrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.UserProfile'])),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Book'])),
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('books', ['BookRelation'])

        # Adding model 'Recommendation'
        db.create_table('books_recommendation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Book'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('review', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('books', ['Recommendation'])
        ...
        m2m_table_name = db.shorten_name('books_book_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['books.book'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('books_userprofile')

        # Deleting model 'BookRelation'
        db.delete_table('books_bookrelation')

        # Deleting model 'Recommendation'
        db.delete_table('books_recommendation')
        ...
        db.delete_table(db.shorten_name('books_book_categories'))
